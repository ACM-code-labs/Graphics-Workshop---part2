...
def main():
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 8 * vertex.itemsize, ctypes.c_void_p(3 * vertex.itemsize))
    glEnableVertexAttribArray(1)

    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 8 * vertex.itemsize, ctypes.c_void_p(6 * vertex.itemsize))
